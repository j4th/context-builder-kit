...
- *"This is opinionated profile — Linear is the planning backend. The Linear-side specifics for rough-in are partially validated, so I'll proceed cautiously and surface anything I'm uncertain about. The Linear Milestone for this framing is [name]. Confirm I should create N Linear Issues under it?"*
