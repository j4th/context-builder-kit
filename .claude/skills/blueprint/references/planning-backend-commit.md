...
| State | `open` | — |
| Initial board Status | **Triage** (via the board's entry automation rule, or set by the operator post-creation — the MCP does not set Projects v2 fields; see `backends.md` § board-automation gap) | — |
