...
# knowledge backend) write verbs (create/update/move/duplicate) across both
# the direct mcp__notion__* and plugin-namespaced tool names; adjust it to
# your configured MCP's tool names if your knowledge backend differs. Reads
# (fetch/search) are unmatched and unaffected.
#
